...
public abstract class ClientLevelMixin extends Level {
    ...
    @ModifyExpressionValue(remap = false, method = "method_24462", at = @At(remap = true, value = "INVOKE", target = "Lnet/minecraft/world/level/biome/AmbientParticleSettings;canSpawn(Lnet/minecraft/util/RandomSource;)Z"))
