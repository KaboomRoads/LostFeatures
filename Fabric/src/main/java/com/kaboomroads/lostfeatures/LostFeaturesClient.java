...
public class LostFeaturesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ColorProviderRegistry.BLOCK.register((blockState, tintGetter, blockPos, i) -> tintGetter != null && blockPos != null ? BiomeColors.getAverageFoliageColor(tintGetter, blockPos) : FoliageColor.getDefaultColor(), ModBlocks.BAOBAB_LEAVES.get());
        ColorProviderRegistry.ITEM.register((itemStack, p_92688_) -> {
            Block blockItem = ((BlockItem) itemStack.getItem()).getBlock();
            BlockState blockstate = blockItem.defaultBlockState();
            return ColorProviderRegistry.BLOCK.get(blockItem).getColor(blockstate, null, null, p_92688_);
        }, ModBlocks.BAOBAB_LEAVES.get());
